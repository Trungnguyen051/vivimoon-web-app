...
## Corpus Check
- 311 files · ~127,840 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1489 nodes · 3507 edges · 125 communities (88 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36db7aa3`
...
### Community 0 - "apiFail"
Cohesion: 0.18
Nodes (20): addressErrorResponse(), DELETE(), PATCH(), GET(), POST(), DELETE(), GET(), POST() (+12 more)

### Community 1 - "use-comparison.test.ts"
Cohesion: 0.38
Nodes (3): mockedApiRequest, UseComparisonMatrixResult, ComparisonMatrix

### Community 2 - "checkout/page.tsx"
Cohesion: 0.24
Nodes (19): AddressDict, EMPTY_FORM, FormState, Stage, Stage, Alert(), AlertDescription(), AlertTitle() (+11 more)

### Community 3 - "parseBody"
Cohesion: 0.24
Nodes (14): PATCH(), jar, POST(), POST(), POST(), POST(), POST(), POST() (+6 more)

### Community 4 - "cart-store.ts"
Cohesion: 0.06
Nodes (42): mockedApiRequest, track, ORDER_RESPONSE, fetchRoutingTo(), json(), PRICED_RESPONSE, CheckoutPage(), makeLine() (+34 more)
...
### Community 6 - "auth.ts"
Cohesion: 0.15
Nodes (15): googleLoginSchema, identifierSchema, LoginInput, loginSchema, normalizePhone(), otpChallengeSchema, otpPurposeSchema, otpRequestSchema (+7 more)
...
Cohesion: 0.13
Nodes (21): CategoryGrid(), CollectionCarousel(), ComparisonTray(), PriceTag(), minVariant(), ProductCard(), QuantityStepper(), AnnouncementBar() (+13 more)
...
Cohesion: 0.10
Nodes (22): collections, favorites, galleries, HOME_ADDRESS, OFFICE_ADDRESS, orders, products, reviews (+14 more)
...
Cohesion: 0.13
Nodes (19): CONTEXT_KEYS, LensViewer(), gallery, ProductGallery(), RatingStars(), ReviewsList(), SpecTable(), Breadcrumb() (+11 more)
...
### Community 22 - "discovery/mock.ts"
Cohesion: 0.25
...
Cohesion: 0.32
Nodes (11): CollectionPage(), resolveTitle(), Empty(), EmptyContent(), EmptyDescription(), EmptyHeader(), EmptyMedia(), emptyMediaVariants (+3 more)
...
### Community 26 - "quiz-scoring.test.ts"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (20): BASELINE_LINES, RESOURCES, saved, upstreamBaseUrl(), upstreamTimeoutMs(), pricedCartSchema, comparisonMatrixSchema, ApiError (+12 more)

### Community 28 - "add-to-cart.tsx"
Cohesion: 0.14
Nodes (19): CartPage(), SuccessPage(), AddToCart(), dict, push, ProductGrid(), dict, product (+11 more)

### Community 29 - "comparison-dialog.tsx"
Cohesion: 0.15
Nodes (9): ComparisonDialog(), matrix, Dialog(), DialogContent(), DialogDescription(), DialogFooter(), DialogHeader(), DialogOverlay() (+1 more)
...
Cohesion: 0.15
Nodes (24): fetchLoyalty(), formatDate(), LoyaltyPage(), fetchOrders(), formatDate(), OrderHistoryPage(), STATUS_VARIANT, discountLabel() (+16 more)
...
Cohesion: 0.11
Nodes (10): QuizFlow(), definition, mockedApiRequest, mockedApiRequest, product, ReviewSourceBadge(), reviews, Badge() (+2 more)
...
Cohesion: 0.15
Nodes (6): Account, AddressError, addressStore, favoriteStore, mockAccount, AccountPatch

### Community 70 - "schemas/orders.ts"
Cohesion: 0.08
Nodes (22): ADDRESS, LINES, OrderStatusTimeline(), PROGRESSION, TERMINAL_DISTINCT, pricedLineSchema, priceLineInputSchema, Address (+14 more)
...
Cohesion: 0.15
Nodes (9): jar, loyaltyHistory, Loyalty, mockLoyalty, store, LoyaltyBalance, loyaltyBalanceSchema, LoyaltyEntry (+1 more)

### Community 73 - "cn"
Cohesion: 0.09
Nodes (32): CollectionFilters(), REPLACEMENTS, SORTS, TYPES, HeroCarousel(), Slide, Accordion(), AccordionContent() (+24 more)

### Community 74 - "cart.ts"
Cohesion: 0.10
Nodes (21): UsePricedCartResult, bestVoucher(), mockPricing, Pricing, BASELINE_LINES, voucherApplies(), voucherDiscount(), cartLineSchema (+13 more)
...
Cohesion: 0.13
Nodes (20): FavoritesPage(), fetchFavorites(), fetchOrder(), OrderDetailPage(), AccountPage(), fetchAccount(), ForgotPasswordPage(), SignInPage() (+12 more)
...
### Community 80 - "discovery.ts"
Cohesion: 0.20
Nodes (10): quizAnswerSchema, quizDefinitionSchema, QuizOption, quizOptionSchema, quizQuestionSchema, QuizSubmitRequest, quizSubmitRequestSchema, QuizSubmitResponse (+2 more)

### Community 81 - "payments.ts"
Cohesion: 0.24
Nodes (6): PaymentIntent, PaymentIntentRequest, paymentIntentRequestSchema, paymentIntentSchema, paymentStatusSchema, BASE
...
### Community 97 - "account.ts"
Cohesion: 0.20
Nodes (9): accountPatchSchema, AddressCreate, addressCreateSchema, AddressPatch, addressPatchSchema, FavoriteCreate, favoriteCreateSchema, savedAddressSchema (+1 more)
...
### Community 116 - "payment-method-picker.tsx"
Cohesion: 0.46
...
### Community 119 - "addresses-manager.test.tsx"
Cohesion: 0.33
Nodes (3): NON_DEFAULT, addresses, SavedAddress

### Community 120 - "client.ts"
Cohesion: 0.09
Nodes (17): AccountForm(), user, SignInForm(), push, FavoriteButton(), toggle(), mockedApiRequest, toPriceLines() (+9 more)
...
## Knowledge Gaps
- **446 isolated node(s):** `Stage`, `push`, `push`, `Stage`, `push` (+441 more)
