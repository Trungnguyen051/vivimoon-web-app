...
## Corpus Check
- 140 files · ~58,980 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 778 nodes · 1514 edges · 71 communities (52 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 1% AMBIGUOUS · INFERRED: 22 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7793a959`
...
Cohesion: 0.17
Nodes (12): 10. Feature Notes, 11. Blocked Items, 12. Testing, 13. Milestones, 14. Files Removed or Changed, 2. Feature Scope, 6. Domain Model Additions, 7. Cart, Rx, and Line Identity (+4 more)
...
Cohesion: 0.08
Nodes (30): SpecTable(), collections, products, reviews, users, Catalog, minPrice(), mockCatalog (+22 more)

### Community 57 - "checkout/page.tsx"
Cohesion: 0.06
Nodes (65): CartPage(), CheckoutPage(), generateOrderId(), SuccessPage(), CollectionPage(), resolveTitle(), LocaleLayout(), HomePage() (+57 more)
...
### Community 62 - "1. Overview"
Cohesion: 0.50
Nodes (4): 1. Overview, Baseline non-goals now in scope, Goals, Non-goals

### Community 63 - "15. Decisions and Open Questions"
Cohesion: 0.67
Nodes (3): 15. Decisions and Open Questions, Resolved — 2026-08-27, Still open

### Community 64 - "3. Architecture — the proxy seam"
Cohesion: 0.67
Nodes (3): 3. Architecture — the proxy seam, Configuration, Resource layout

### Community 65 - "4. API Contract"
Cohesion: 0.67
Nodes (3): 4. API Contract, Endpoint catalogue, Envelope

### Community 68 - "auth.ts"
Cohesion: 0.08
Nodes (31): MockUser, Auth, mockAuth, OtpRecord, otps, resetMockAuthState(), ResetRecord, resets (+23 more)
...
### Community 70 - "Task 18: Cart page + line item + order summary"
Cohesion: 0.33
...
## Knowledge Gaps
- **265 isolated node(s):** `jar`, `geistSans`, `geistMono`, `metadata`, `$schema` (+260 more)
