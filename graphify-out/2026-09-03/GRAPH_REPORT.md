...
## Corpus Check
- 217 files · ~96,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1116 nodes · 2409 edges · 69 communities (52 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 27 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e423bcb4`
...
1. `cn()` - 103 edges
2. `apiOk()` - 39 edges
3. `getDictionary()` - 35 edges
4. `isLocale()` - 26 edges
5. `Locale` - 25 edges
6. `apiFail()` - 24 edges
7. `parseBody()` - 24 edges
...
Cohesion: 0.06
Nodes (66): fetchOrders(), formatDate(), OrderHistoryPage(), STATUS_VARIANT, ForgotPasswordPage(), SignInPage(), SignUpPage(), CartPage() (+58 more)
...
Cohesion: 0.07
Nodes (40): AccountForm(), user, AccountPage(), fetchAccount(), ForgotPasswordForm(), reportServer(), requestCode(), submitPassword() (+32 more)
...
### Community 5 - "add-to-cart.tsx"
Cohesion: 0.05
Nodes (45): geistMono, geistSans, metadata, mockedApiRequest, track, ORDER_RESPONSE, makeLine(), seedLastOrder() (+37 more)
...
Cohesion: 0.12
Nodes (20): emptyRxDraft, EyeFields(), RxDraft, RxEyeDraft, RxRanges, RxSelector(), dict, eyeSummary() (+12 more)
...
Cohesion: 0.12
Nodes (18): SpecTable(), collectionSchema, Currency, ProductBadge, productBadgeSchema, productQuerySchema, productSchema, ProductSpecs (+10 more)
...
Cohesion: 0.13
Nodes (14): HOME_ADDRESS, OFFICE_ADDRESS, orders, pricedCartSchema, priceLineInputSchema, voucherSchema, Order, OrderLine (+6 more)
...
Cohesion: 0.08
Nodes (27): BASELINE_LINES, ADDRESS, LINES, ApiMode, DEPENDS_ON, rawMode(), readMode(), resolveMode() (+19 more)
...
Cohesion: 0.18
Nodes (12): orders, mockOrders, OrderError, Orders, randomId(), randomOrderCode(), randomSuffix(), resetMockOrdersState() (+4 more)
...
### Community 63 - "rx.ts"
Cohesion: 0.28
Nodes (7): lensTypeSchema, AXIS_STEPS, LensType, rxEyeSchema, rxSchema, SPH_STEPS, ok
...
## Knowledge Gaps
- **348 isolated node(s):** `Stage`, `push`, `push`, `user`, `STATUS_VARIANT` (+343 more)
