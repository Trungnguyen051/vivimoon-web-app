...
## Corpus Check
- 320 files · ~132,015 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1524 nodes · 3590 edges · 126 communities (85 shown, 41 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 30 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5da3ca70`
...
### Community 0 - "apiOk"
Cohesion: 0.18
Nodes (26): addressErrorResponse(), DELETE(), PATCH(), GET(), POST(), DELETE(), GET(), POST() (+18 more)

### Community 1 - "field.tsx"
Cohesion: 0.20
Nodes (9): FieldContent(), FieldDescription(), FieldLegend(), FieldSeparator(), FieldSet(), FieldTitle(), fieldVariants, Label() (+1 more)

### Community 2 - "checkout/page.tsx"
Cohesion: 0.23
Nodes (20): AddressDict, EMPTY_FORM, FormState, Stage, Stage, Alert(), AlertDescription(), AlertTitle() (+12 more)
...
### Community 4 - "rx.ts"
Cohesion: 0.10
Nodes (26): emptyRxDraft, EyeFields(), RxDraft, RxEyeDraft, RxRanges, RxSelector(), dict, AXIS_STEPS (+18 more)

### Community 5 - "cookie.ts"
Cohesion: 0.11
Nodes (11): ADDRESS, jar, jar, jar, secret(), SESSION_COOKIE, sessionCookieOptions(), sign() (+3 more)

### Community 6 - "comparison-dialog.tsx"
Cohesion: 0.21
...
### Community 9 - "auth.ts"
Cohesion: 0.18
Nodes (13): googleLoginSchema, identifierSchema, loginSchema, normalizePhone(), otpChallengeSchema, otpPurposeSchema, otpRequestSchema, otpVerifyResultSchema (+5 more)
...
Cohesion: 0.08
Nodes (27): req(), mockedApiRequest, UseComparisonMatrixResult, collectionSchema, CompareRequest, compareRequestSchema, ComparisonMatrix, ComparisonRow (+19 more)

### Community 15 - "mock/index.ts"
Cohesion: 0.09
Nodes (20): collections, favorites, galleries, HOME_ADDRESS, OFFICE_ADDRESS, orders, products, MockUser (+12 more)
...
Cohesion: 0.06
Nodes (25): geistMono, geistSans, metadata, QuizFlow(), definition, mockedApiRequest, CompareToggle(), ComparisonDialog() (+17 more)

### Community 18 - "i18n seam (locale-prefixed routes, getDictionary)"
Cohesion: 0.15
Nodes (13): Multi-language/locale switcher (topbar), Utility topbar (Coolmate), getDictionary(locale) function, Rationale for lightweight custom i18n over next-intl, i18n seam (locale-prefixed routes, getDictionary), LocaleSwitcher component, middleware.ts (locale detection/redirect), Tech stack (Next.js App Router, React 19, TS strict, Tailwind v4, shadcn/ui, embla, RHF+zod, GA4, Vitest) (+5 more)

### Community 19 - "cart-store.ts"
Cohesion: 0.05
Nodes (43): mockedApiRequest, track, DEFAULT_ADDRESS, fetchRoutingTo(), json(), PRICED_RESPONSE, ORDER_RESPONSE, fetchRoutingTo() (+35 more)
...
Cohesion: 0.11
Nodes (16): POST(), GUEST_ADDRESS, placeGuestOrder(), POST(), ApiMode, DEPENDS_ON, isAnyUpstream(), rawMode() (+8 more)

### Community 22 - "AddressesManager"
Cohesion: 0.22
Nodes (3): AddressesManager(), NON_DEFAULT, toFormState()

### Community 23 - "spec-table.tsx"
Cohesion: 0.38
Nodes (5): SpecTable(), baseSpecs, dict, ADR-0011, ProductSpecs
...
Cohesion: 0.21
Nodes (9): bestVoucher(), mockPricing, Pricing, BASELINE_LINES, voucherApplies(), voucherDiscount(), shipping, PriceCartRequest (+1 more)

### Community 27 - "common.ts"
Cohesion: 0.06
Nodes (26): BASELINE_LINES, ADDRESS, BASELINE_LINES, jar, ADDRESS, LINES, RESOURCES, saved (+18 more)

### Community 28 - "add-to-cart.tsx"
Cohesion: 0.14
Nodes (18): AddToCart(), ADR-0010, resolveVariant(), coloredProduct, colorlessProduct, dict, VariantSelector(), selectColor() (+10 more)

### Community 29 - "Product"
Cohesion: 0.23
Nodes (8): reviews, Catalog, minPrice(), mockCatalog, Product, ProductQuery, Review, cheapestVariant()
...
### Community 31 - "product/[slug]/page.tsx"
Cohesion: 0.13
Nodes (19): CONTEXT_KEYS, LensViewer(), gallery, ProductGallery(), RatingStars(), Badge(), badgeVariants, Breadcrumb() (+11 more)
...
Cohesion: 0.14
Nodes (13): UsePricedCartResult, cartLineSchema, cartStateSchema, priceCartRequestSchema, PricedCart, PriceLineInput, ShippingSelection, shippingSelectionSchema (+5 more)
...
Cohesion: 0.09
Nodes (23): GET(), QuizAnswer, quizAnswerSchema, quizDefinitionSchema, QuizOption, quizOptionSchema, QuizQuestion, quizQuestionSchema (+15 more)

### Community 66 - "Task 6: ProductRepository interface + mock implementation"
Cohesion: 0.25
Nodes (8): Task 5: Mock content, Task 6: ProductRepository interface + mock implementation, Task 7: i18n seam (config, dictionaries, middleware), Task 8: Analytics seam (GA4), Analytics seam (GA4 via typed track() wrapper), GA4 ecommerce events (view_item_list, select_item, view_item, add_to_cart, remove_from_cart, view_cart, begin_checkout, purchase), @next/third-parties GoogleAnalytics component, track(event) function (gtag wrapper, no-op if unconfigured)

### Community 69 - "account.ts"
Cohesion: 0.17
Nodes (10): addresses, AccountPatch, accountPatchSchema, AddressCreate, addressCreateSchema, AddressPatch, addressPatchSchema, FavoriteCreate (+2 more)

### Community 70 - "dictionaries.ts"
Cohesion: 0.05
Nodes (87): AddressesPage(), fetchAddresses(), FavoritesPage(), fetchFavorites(), fetchLoyalty(), formatDate(), LoyaltyPage(), fetchOrder() (+79 more)

### Community 71 - "order-status-timeline.tsx"
Cohesion: 0.33
...
### Community 73 - "cn"
Cohesion: 0.08
Nodes (32): CollectionFilters(), SORTS, HeroCarousel(), Slide, QuantityStepper(), Accordion(), AccordionContent(), AccordionItem() (+24 more)
...
### Community 80 - "price/route.ts"
Cohesion: 0.24
Nodes (4): BASELINE_LINES, jar, pricing, PricingError
...
Cohesion: 0.12
Nodes (14): Auth, mockAuth, OtpRecord, otps, resetMockAuthState(), ResetRecord, resets, store (+6 more)

### Community 89 - "shipping/mock.ts"
Cohesion: 0.29
...
Cohesion: 0.24
Nodes (9): quiz, ADR-0005, DiscoveryError, mockDiscovery, toComparisonRow(), QuizDefinition, EYE_ENLARGEMENT_BANDS, eyeEnlargementBand (+1 more)
...
Cohesion: 0.14
Nodes (14): pricedLineSchema, priceLineInputSchema, Address, addressSchema, shippingOptionSchema, ShippingQuoteRequest, shippingQuoteRequestSchema, OrderLine (+6 more)
...
### Community 119 - "add-to-cart.test.tsx"
Cohesion: 0.33
Nodes (3): dict, push, productLineSchema

### Community 120 - "schema.ts"
Cohesion: 0.33
Nodes (5): addressLabelSchema, CheckoutForm, CheckoutFormInput, checkoutSchema, VALID

### Community 124 - "client.ts"
Cohesion: 0.12
Nodes (15): CheckoutPage(), FavoriteButton(), toggle(), mockedApiRequest, toPriceLines(), usePricedCart(), SessionStatus, SessionStore (+7 more)

### Community 125 - "account/mock.ts"
Cohesion: 0.17
Nodes (5): Account, AddressError, addressStore, favoriteStore, mockAccount
...
## Knowledge Gaps
- **459 isolated node(s):** `Stage`, `push`, `push`, `Stage`, `push` (+454 more)
