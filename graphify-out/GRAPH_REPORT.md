...
## Corpus Check
- 13 files · ~88,442 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1031 nodes · 2137 edges · 72 communities (57 shown, 15 thin omitted)
...
2. `apiOk()` - 35 edges
3. `Locale` - 24 edges
4. `getDictionary()` - 22 edges
5. `parseBody()` - 21 edges
6. `apiFail()` - 20 edges
...
- `SheetDescription()` --calls--> `cn()`  [EXTRACTED]
  components/ui/sheet.tsx → lib/utils/cn.ts
...
Cohesion: 0.06
Nodes (55): REPLACEMENTS, SORTS, TYPES, ProductGallery(), RatingStars(), ReviewsList(), Accordion(), AccordionContent() (+47 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (42): jar, GET(), PATCH(), jar, POST(), POST(), POST(), POST() (+34 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (39): ADDRESS, LINES, defaultShippingOptions, shippingRates, ApiMode, DEPENDS_ON, rawMode(), readMode() (+31 more)
...
Cohesion: 0.11
Nodes (17): POST(), PaymentMethodPicker(), dict, payments, mockPayments, PaymentError, Payments, PaymentIntent (+9 more)
...
Cohesion: 0.20
Nodes (18): Stage, Alert(), AlertAction(), AlertDescription(), alertVariants, Button(), buttonVariants, Field() (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.14
Nodes (19): EyeFields(), eyeSummary(), RxSummary(), AXIS_STEPS, LensType, Rx, RxEye, rxEyeSchema (+11 more)

### Community 11 - "Community 11"
Cohesion: 0.14
Nodes (10): AnnouncementBar(), Footer(), Header(), LocaleSwitcher(), defaultLocale, isLocale(), Locale, locales (+2 more)
...
Cohesion: 0.13
Nodes (16): SpecTable(), Collection, Currency, LensType, lensTypeSchema, ProductBadge, productBadgeSchema, ProductSpecs (+8 more)

### Community 14 - "Community 14"
Cohesion: 0.19
Nodes (14): mockedApiRequest, track, SuccessPage(), cartCount(), cartReducer(), CART_STORAGE, CartStore, mergeLines() (+6 more)

### Community 15 - "Community 15"
Cohesion: 0.12
Nodes (14): MockUser, Auth, mockAuth, OtpRecord, otps, resetMockAuthState(), ResetRecord, resets (+6 more)
...
Cohesion: 0.15
Nodes (11): AddToCart(), dict, emptyRxDraft, RxDraft, RxEyeDraft, RxRanges, RxSelector(), dict (+3 more)

### Community 19 - "Community 19"
Cohesion: 0.20
Nodes (9): collections, products, reviews, users, vouchers, Catalog, minPrice(), mockCatalog (+1 more)
...
Cohesion: 0.12
Nodes (15): BASELINE_LINES, cartLineSchema, cartStateSchema, priceCartRequestSchema, pricedCartSchema, PriceLineInput, priceLineInputSchema, ShippingSelection (+7 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (7): user, push, SignInForm(), push, OrderSummary(), dict, getDictionary()

### Community 23 - "Community 23"
Cohesion: 0.29
Nodes (12): CollectionPage(), resolveTitle(), CollectionFilters(), Empty(), EmptyContent(), EmptyDescription(), EmptyHeader(), EmptyMedia() (+4 more)
...
Cohesion: 0.21
Nodes (8): PriceTag(), minVariant(), ProductCard(), product, dict, product, VariantSelector(), formatPrice()
...
Cohesion: 0.27
Nodes (9): ProductGrid(), Gtag, product, track(), AnalyticsEvent, Ga4Item, toGa4Items(), useAnalytics() (+1 more)
...
Cohesion: 0.19
Nodes (12): googleLoginSchema, identifierSchema, otpChallengeSchema, otpPurposeSchema, otpRequestSchema, otpVerifyResultSchema, otpVerifySchema, passwordResetSchema (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.28
Nodes (8): MegaNav(), MobileNav(), getNavItems(), NavItem, dictionaries, Dictionary, en, vi
...
Cohesion: 0.24
Nodes (8): SignUpForm(), SessionStatus, SessionStore, SessionUser, user, useSessionStore, SessionSync(), apiRequest()

### Community 33 - "Community 33"
Cohesion: 0.23
Nodes (6): CartPage(), mockedApiRequest, toPriceLines(), usePricedCart(), UsePricedCartResult, PricedCart
...
Cohesion: 0.22
Nodes (6): AccountForm(), AccountPage(), fetchAccount(), ApiResult, INTERNAL, ApiError

### Community 36 - "Community 36"
Cohesion: 0.27
Nodes (8): CheckoutPage(), generateOrderId(), AlertTitle(), isPhone(), CheckoutForm, CheckoutFormInput, checkoutSchema, VALID
...
Cohesion: 0.28
Nodes (6): CartLineItem(), dict, line, lineWithRx, rx, QuantityStepper()

### Community 40 - "Community 40"
Cohesion: 0.29
Nodes (6): collectionSchema, productQuerySchema, productSchema, reviewSchema, validProduct, configured
...
Cohesion: 0.70
Nodes (5): ForgotPasswordForm(), reportServer(), requestCode(), submitPassword(), verifyCode()
...
## Knowledge Gaps
- **323 isolated node(s):** `LooseEye`, `Gtag`, `Ga4Item`, `Envelope`, `PriceLineInput` (+318 more)
