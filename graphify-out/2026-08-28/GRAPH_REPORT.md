...
1. `cn()` - 101 edges
2. `Locale` - 21 edges
3. `getDictionary()` - 18 edges
4. `Vivimoon M1 — Foundation Implementation Plan` - 18 edges
5. `Coolmate.me Feature & Structure Analysis` - 17 edges
6. `isLocale()` - 16 edges
7. `Dictionary` - 16 edges
8. `compilerOptions` - 16 edges
9. `Vivimoon — Client Scope Design Spec` - 16 edges
10. `Vivimoon Storefront Baseline Design Spec` - 16 edges
...
## Knowledge Gaps
- **246 isolated node(s):** `geistSans`, `geistMono`, `metadata`, `$schema`, `style` (+241 more)
